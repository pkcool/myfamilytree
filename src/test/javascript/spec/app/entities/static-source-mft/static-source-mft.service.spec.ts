...
describe('Service Tests', () => {
    ...
    describe('StaticSourceMft Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(StaticSourceMftService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/static-sources';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return StaticSourceMft', () => {
