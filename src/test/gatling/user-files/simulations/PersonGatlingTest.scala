...
class PersonGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Person entity")
        ...
        .repeat(2) {
            ...
            .post("/api/people")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "idNumber":"SAMPLE_TEXT", "surname":"SAMPLE_TEXT", "foreNames":"SAMPLE_TEXT", "sex":null, "placeOfBirth":"SAMPLE_TEXT", "dateOfBirth":"2020-01-01T00:00:00.000Z", "placeOfDeath":"SAMPLE_TEXT", "dateOfDeath":"2020-01-01T00:00:00.000Z", "briefNote":"SAMPLE_TEXT", "notes":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
