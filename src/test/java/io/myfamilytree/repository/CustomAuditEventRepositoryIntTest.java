...
import io.myfamilytree.config.audit.AuditEventConverter;
import io.myfamilytree.domain.PersistentAuditEvent;
...
import static io.myfamilytree.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
