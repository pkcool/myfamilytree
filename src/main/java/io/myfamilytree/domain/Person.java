...
public class Person implements Serializable {
    ...
    public Person children(Set<Person> people) {
        this.children = people;
        return this;
    }

    public Person addChildren(Person person) {
    ...
    public void setChildren(Set<Person> people) {
        this.children = people;
    }
